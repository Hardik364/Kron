...
impl Default for AgentConfig {
    fn default() -> Self {
        Self {
            tls_cert_path: PathBuf::from("/var/lib/kron/agent/client.crt"),
            tls_key_path: PathBuf::from("/var/lib/kron/agent/client.key"),
            collector_endpoint: "https://localhost:9001".to_string(),
            ring_buffer_bytes: 64 * 1024 * 1024, // 64 MB
            batch_size: 1000,
            batch_timeout_ms: 100,
            heartbeat_interval_secs: 30,
            disk_buffer_path: PathBuf::from("/var/lib/kron/agent/buffer"),
