...
interface SeverityBadgeProps {
  severity: string;
  /** If true, renders a slightly larger pill with full label text. */
  large?: boolean;
}
...
function resolveSeverity(raw: string): SeverityStyle {
 ...
 */
export default function SeverityBadge(props: SeverityBadgeProps): JSX.Element {
