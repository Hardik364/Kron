          ...
          <form onSubmit={(e) => void handleSubmit(e)} novalidate>
            <div style={{ display: 'flex', 'flex-direction': 'column', gap: '20px' }}>
              ...
              <div>
                ...
                <input id="email" type="email" autocomplete="email" required value={email()} onInput={(e) => setEmail(e.currentTarget.value)} placeholder="analyst@organisation.in" style={inputStyle} disabled={authState.isLoading} aria-required="true"/>
              </div>
              ...
              <div>
                ...
                <input id="password" type="password" autocomplete="current-password" required value={password()} onInput={(e) => setPassword(e.currentTarget.value)} placeholder="••••••••••••" style={inputStyle} disabled={authState.isLoading} aria-required="true"/>
              </div>
              ...
              <Show when={showTotp()}>
                <div>
                  ...
                  <input id="totp" type="text" inputmode="numeric" autocomplete="one-time-code" pattern="[0-9]{6}" maxlength="6" value={totp()} onInput={(e) => setTotp(e.currentTarget.value)} placeholder="000000" style={{ ...inputStyle, 'letter-spacing': '0.3em', 'text-align': 'center', 'font-family': 'var(--font-mono)' }} disabled={authState.isLoading} aria-label="6-digit TOTP code from your authenticator app"/>
            ...
            color: '#fca5a5',
              ...
              {/* Submit button */}
              <button type="submit" disabled={authState.isLoading || email().length === 0 || password().length === 0} style={{
            padding: '11px 16px',
...
function SpinnerIcon() {
    return (<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style={{ animation: 'spin 0.8s linear infinite' }}>
